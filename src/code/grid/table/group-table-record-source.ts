...
export class GroupTableRecordSource extends UserTableRecordSource {
    ...
    constructor() {
        super(TableRecordSource.TypeId.Group);
        this.setName(GroupTableRecordSource.baseName +
            (++GroupTableRecordSource._constructCount).toString(10));
    ...
    override loadFromJson(element: JsonElement) {
        ...
        const definitionElementArray = element.tryGetElementArray(GroupTableRecordSource.jsonTag_DefinitionKeys);
        ...
        if (definitionElementArray !== undefined && definitionElementArray.length > 0) {
            ...
            for (const definitionElement of definitionElementArray) {
                ...
                if (definition === undefined) {
                    ...
                    if (typeId !== GroupTableRecordSource.definitionTypeId) {
    ...
    override saveToJson(element: JsonElement) {
        ...
        element.setElementArray(GroupTableRecordSource.jsonTag_DefinitionKeys, keyElementArray);
    }
...
export namespace GroupTableRecordSource {

    export function createFromRecordDefinitionList(list: TableRecordSource): GroupTableRecordSource {
        const result = new GroupTableRecordSource();
