...
import { ServerTableRecordSource, TableRecordSource } from './table-record-source';

export class IvemIdServerTableRecordSource extends ServerTableRecordSource {
    ...
    constructor() {
        super(TableRecordSource.TypeId.IvemIdServer);
