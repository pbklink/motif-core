...
export class TableFieldSourceDefinitionCachingFactoryService<TypeId> {
    private readonly _definitionsByTypeId = new Map<TypeId, TableFieldSourceDefinition<TypeId>>();
    private readonly _definitionsByName = new Map<string, TableFieldSourceDefinition<TypeId>>();

    constructor(readonly definitionFactory: TableFieldSourceDefinitionFactory<TypeId>) {
    ...
    get(typeId: TypeId): TableFieldSourceDefinition<TypeId> {
