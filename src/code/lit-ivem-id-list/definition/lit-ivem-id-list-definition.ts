...
export abstract class LitIvemIdListDefinition {
    ...
    saveToJson(element: JsonElement) {
        element.setString(LitIvemIdListDefinition.typeIdJsonName, LitIvemIdListDefinition.Type.idToJsonValue(this.typeId));
    }

    abstract tryLock(locker: LockOpenListItem.Locker): Result<LitIvemIdListDefinition>;
...
export namespace LitIvemIdListDefinition {
    ...
    export namespace Type {
        ...
        const infosObject: InfosObject = {
            ...
            NamedExplicitReference: {
                id: TypeId.NamedExplicitReference,
                jsonValue: 'NamedExplicitReference',
            },
            ZenithWatchlist: {
